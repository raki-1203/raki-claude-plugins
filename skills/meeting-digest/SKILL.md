...
## 주요 논의
### <소주제 1>
<논의 내용. 누가 무슨 입장이었는지 문맥상 파악되면 명시. 핵심 발언은 인용 가능>
> "발언 인용" — (mm:ss)
...
## 액션 아이템
- [ ] <담당자가 문맥상 명확하면 명시, 아니면 "미정"> · <할 일> · 기한: <있으면>
- [ ] ...
...
4. **TL;DR**: 회의 안 본 사람도 핵심을 알 수 있게.
5. 전사 품질이 낮은 구간(반복/잡음)은 무시. 의미 없는 자동 자막 산출물(예: 같은 단어 반복)은 노이즈로 판단.
