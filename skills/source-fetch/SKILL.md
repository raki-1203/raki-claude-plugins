...
5. `notebooklm generate report --format briefing-doc --wait` + `download report --latest … briefing.md`
6. `notebooklm generate report --format study-guide --wait` + `download report --latest … study-guide.md`
